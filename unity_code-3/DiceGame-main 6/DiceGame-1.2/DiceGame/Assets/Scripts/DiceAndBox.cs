...
public class DiceAndBox : MonoBehaviour
{
    ...
    private string currentRoundid = string.Empty;
    ...
    public void RollSixDice(string roundid)
    {
        ...
        diceRoller.RollDices(diceResults, roundid);
    }

    public void SpawnDiceIfNeeded()
    {
        SpawnDice(currentRoundid);
    }
    ...
    public void ThrowDiceIfNeeded(int[] results, string roundid)
    {
    ...
    public void SpawnDices(int[] results, string roundid)
    {
        ...
        diceRoller.SpawnDices(results, roundid);
    }
