...
namespace AdvancedInputFieldSamples
{
	public class RegisterView: MonoBehaviour
	{
		...
		private void Awake()
		{
			...
			emailInput = centerGroup.Find("Email").GetComponent<AdvancedInputField>();
			passwordInput = centerGroup.Find("Password").GetComponent<AdvancedInputField>();
			confirmPasswordInput = centerGroup.Find("ConfirmPassword").GetComponent<AdvancedInputField>();
			firstNameInput = centerGroup.Find("FirstName").GetComponent<AdvancedInputField>();
			lastNameInput = centerGroup.Find("LastName").GetComponent<AdvancedInputField>();
			registerButton = centerGroup.Find("RegisterButton").GetComponent<Button>();
		}
