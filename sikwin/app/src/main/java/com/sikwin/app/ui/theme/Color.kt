...
val BottomNavBackground = Color(0xFF1A1A1A)
val CardBackground = Color(0xFF252525)
val GoldGradient = listOf(Color(0xFFFFD700), Color(0xFFFFA500))

/** Cricket / IPL screen — match web sportsbook reference */
val CricketScreenBg = Color(0xFF0F1218)
val CricketHeaderBg = Color(0xFF1A1F2B)
