...
public class SafeArea : MonoBehaviour
{
    ...
    void ApplySafeArea()
    {
        ...
        // On WebGL, Screen.safeArea often returns wrong values (especially bottom inset),
        // which clips the gameplay UI and hides the bottom numbers/chips. Use full screen.
